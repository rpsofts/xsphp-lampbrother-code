<?php /* Smarty version 2.6.18, created on 2014-01-21 13:00:16
         compiled from default/register.tpl */ ?>
<html>
	<head>
	...
	<body>
		<div id="reg">
				...
				<script language="javascript" type="text/javascript">
        			...
        			<div class="dd">
					<form name="form2"  action="reg_new.php?action=reg" method="post" onsubmit="return validate()">					<input type="hidden" name="url" value="<?php echo $this->_tpl_vars['url']; ?>
">
     					 <ul>
