...
" onsubmit="return confirm('你确定要删除选中的图片项吗?')"  >
			<div class="msg-box">
				<ul class="viewmess">
					<li class="dark-row">
...
">修改</a>】
							<?php if ($this->_tpl_vars['users'][$this->_sections['doc']['index']]['id'] != 1): ?>
							【<a onclick="return confirm('确定要删除用户<?php echo $this->_tpl_vars['users'][$this->_sections['doc']['index']]['userName']; ?>
吗？')" href="main.php?action=editUser&page=<?php echo $this->_tpl_vars['pageInfo']['current_page']; ?>
...
</b> 个用户,本页显示 <?php echo $this->_tpl_vars['pageInfo']['page_start']; ?>
