<?php
	...
	@define("DB_PWD", "1993319");			       			//数据库密码
	@define("DB_NAME", "xscms");	         				//数据库名称
	@define("TAB_PREFIX", "cms_");					//前缀
	//应用程序相关设置
	@define("APP_NAME", "LAMP兄弟连网络工作室");            	//应用程序名称

	//框架路径设置
	@define("CMS_ROOT", "D:/Program Files/lamp/Apache24/htdocs/xsphp/cms/");					//系统根目录
	...
	@define("APP_PATH", "/xsphp/cms/");   					 //安装路径
